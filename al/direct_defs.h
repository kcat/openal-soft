...
{                                                                             \
    return Name##Impl##Ext(context, n1);                                      \
}
