...
void AL_APIENTRY alEventControlSOFT(gsl::not_null<ALCcontext*> context, ALsizei count,
...
void AL_APIENTRY alEventCallbackSOFT(gsl::not_null<ALCcontext*> context, ALEVENTPROCSOFT callback,
