    ...
    EaxFxSlotIndexValue index)
{
    ...
    eax_call_ = &eax_al_context_->get_call();
    ...
    unsigned long eax_flags)
{
    eax_validate_range<EaxFxSlotException>(
        ...
        eax_flags,
        0UL,
        ~(eax_call_->get_version() == 4 ? EAX40FXSLOTFLAGS_RESERVED : EAX50FXSLOTFLAGS_RESERVED));
}
...
{
    eax_validate_fx_slot_all(static_cast<const EAX40FXSLOTPROPERTIES&>(fx_slot));
...
void ALeffectslot::eax_get_fx_slot_all() const
{
    switch (eax_call_->get_version())
    {
        case 4:
            eax_call_->set_value<EaxFxSlotException, EAX40FXSLOTPROPERTIES>(eax_eax_fx_slot_);
            break;

        case 5:
            eax_call_->set_value<EaxFxSlotException, EAX50FXSLOTPROPERTIES>(eax_eax_fx_slot_);
            break;
...
void ALeffectslot::eax_get_fx_slot() const
{
    switch (eax_call_->get_property_id())
    {
        ...
        case EAXFXSLOT_LOADEFFECT:
            eax_call_->set_value<EaxFxSlotException>(eax_eax_fx_slot_.guidLoadEffect);
            break;

        case EAXFXSLOT_VOLUME:
            eax_call_->set_value<EaxFxSlotException>(eax_eax_fx_slot_.lVolume);
            break;

        case EAXFXSLOT_LOCK:
            eax_call_->set_value<EaxFxSlotException>(eax_eax_fx_slot_.lLock);
            break;

        case EAXFXSLOT_FLAGS:
            eax_call_->set_value<EaxFxSlotException>(eax_eax_fx_slot_.ulFlags);
            break;

        case EAXFXSLOT_OCCLUSION:
            eax_call_->set_value<EaxFxSlotException>(eax_eax_fx_slot_.lOcclusion);
            break;

        case EAXFXSLOT_OCCLUSIONLFRATIO:
            eax_call_->set_value<EaxFxSlotException>(eax_eax_fx_slot_.flOcclusionLFRatio);
            break;
...
{
    switch (eax_call_->get_property_set_id())
    {
    ...
    ALenum al_effect_type)
{
    ...
    eax_effect_ = nullptr;
    eax_effect_ = eax_create_eax_effect(al_effect_type, *eax_call_);
...
void ALeffectslot::eax_defer_fx_slot_effect()
{
    const auto& eax_effect_id =
        eax_call_->get_value<EaxFxSlotException, const decltype(EAX40FXSLOTPROPERTIES::guidLoadEffect)>();

    eax_validate_fx_slot_effect(eax_effect_id);
    eax_set_fx_slot_effect(eax_effect_id);
}

void ALeffectslot::eax_defer_fx_slot_volume()
{
    const auto& eax_volume =
        eax_call_->get_value<EaxFxSlotException, const decltype(EAX40FXSLOTPROPERTIES::lVolume)>();

    eax_validate_fx_slot_volume(eax_volume);
    eax_set_fx_slot_volume(eax_volume);
}

void ALeffectslot::eax_defer_fx_slot_lock()
{
    const auto& eax_lock =
        eax_call_->get_value<EaxFxSlotException, const decltype(EAX40FXSLOTPROPERTIES::lLock)>();

    eax_validate_fx_slot_lock(eax_lock);
    eax_set_fx_slot_lock(eax_lock);
}

void ALeffectslot::eax_defer_fx_slot_flags()
{
    const auto& eax_flags =
        eax_call_->get_value<EaxFxSlotException, const decltype(EAX40FXSLOTPROPERTIES::ulFlags)>();

    eax_validate_fx_slot_flags(eax_flags);
    eax_set_fx_slot_flags(eax_flags);
}

// [[nodiscard]]
bool ALeffectslot::eax_defer_fx_slot_occlusion()
{
    const auto& eax_occlusion =
        eax_call_->get_value<EaxFxSlotException, const decltype(EAX50FXSLOTPROPERTIES::lOcclusion)>();
...
// [[nodiscard]]
bool ALeffectslot::eax_defer_fx_slot_occlusion_lf_ratio()
{
    const auto& eax_occlusion_lf_ratio =
        eax_call_->get_value<EaxFxSlotException, const decltype(EAX50FXSLOTPROPERTIES::flOcclusionLFRatio)>();
...
// [[nodiscard]]
bool ALeffectslot::eax_defer_fx_slot_all()
{
    switch (eax_call_->get_version())
    {
        case 4:
            {
                const auto& eax_all =
                    eax_call_->get_value<EaxFxSlotException, const EAX40FXSLOTPROPERTIES>();

                eax_validate_fx_slot_all(eax_all);
        ...
        case 5:
            {
                const auto& eax_all =
                    eax_call_->get_value<EaxFxSlotException, const EAX50FXSLOTPROPERTIES>();
...
bool ALeffectslot::eax_set_fx_slot()
{
    switch (eax_call_->get_property_id())
    {
        ...
        case EAXFXSLOT_ALLPARAMETERS:
            return eax_defer_fx_slot_all();

        case EAXFXSLOT_LOADEFFECT:
            eax_defer_fx_slot_effect();
            return false;
        ...
        case EAXFXSLOT_LOCK:
            eax_defer_fx_slot_lock();
            return false;

        case EAXFXSLOT_FLAGS:
            eax_defer_fx_slot_flags();
            return false;

        case EAXFXSLOT_OCCLUSION:
            return eax_defer_fx_slot_occlusion();

        case EAXFXSLOT_OCCLUSIONLFRATIO:
            return eax_defer_fx_slot_occlusion_lf_ratio();
...
{ if(eax_effect_) eax_effect_->dispatch(); }
