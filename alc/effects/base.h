...
auto ReverbStateFactory_getFactory() -> gsl::strict_not_null<EffectStateFactory*>;
auto ChorusStateFactory_getFactory() -> gsl::strict_not_null<EffectStateFactory*>;
auto AutowahStateFactory_getFactory() -> gsl::strict_not_null<EffectStateFactory*>;
auto CompressorStateFactory_getFactory() -> gsl::strict_not_null<EffectStateFactory*>;
auto DistortionStateFactory_getFactory() -> gsl::strict_not_null<EffectStateFactory*>;
auto EchoStateFactory_getFactory() -> gsl::strict_not_null<EffectStateFactory*>;
...
auto PshifterStateFactory_getFactory() -> gsl::strict_not_null<EffectStateFactory*>;
auto VmorpherStateFactory_getFactory() -> gsl::strict_not_null<EffectStateFactory*>;
