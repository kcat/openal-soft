...
struct GaussianTable : CubicTable { consteval GaussianTable() noexcept; };
DECL_HIDDEN extern constinit const GaussianTable gGaussianFilter;
...
DECL_HIDDEN extern constinit const CubicFilter gCubicTable;
