...
void ALCcontext::eax_unlock_legacy_fx_slots() noexcept
{
    if (eax_call_.get_version() != 5 || eax_are_legacy_fx_slots_unlocked_)
        return;
...
{
    const auto source_id = eax_call_.get_property_al_name();
    ...
    source->eax_dispatch(eax_call_);
}

void ALCcontext::eax_get_primary_fx_slot_id()
{
    eax_call_.set_value<ContextException>(eax_.context.guidPrimaryFXSlotID);
}

void ALCcontext::eax_get_distance_factor()
{
    eax_call_.set_value<ContextException>(eax_.context.flDistanceFactor);
}

void ALCcontext::eax_get_air_absorption_hf()
{
    eax_call_.set_value<ContextException>(eax_.context.flAirAbsorptionHF);
}

void ALCcontext::eax_get_hf_reference()
{
    eax_call_.set_value<ContextException>(eax_.context.flHFReference);
}
...
void ALCcontext::eax_get_last_error()
{
    ...
    eax_last_error_ = EAX_OK;
    eax_call_.set_value<ContextException>(eax_last_error);
}

void ALCcontext::eax_get_speaker_config()
{
    eax_call_.set_value<ContextException>(eax_speaker_config_);
}

void ALCcontext::eax_get_session()
{
    eax_call_.set_value<ContextException>(eax_session_);
}

void ALCcontext::eax_get_macro_fx_factor()
{
    eax_call_.set_value<ContextException>(eax_.context.flMacroFXFactor);
}
...
void ALCcontext::eax_get_context_all()
{
    ...
    {
        case 4:
            eax_call_.set_value<ContextException>(static_cast<const EAX40CONTEXTPROPERTIES&>(eax_.context));
            break;

        case 5:
            eax_call_.set_value<ContextException>(static_cast<const EAX50CONTEXTPROPERTIES&>(eax_.context));
            break;
...
void ALCcontext::eax_get()
{
    switch (eax_call_.get_property_id())
    {
        ...
        case EAXCONTEXT_PRIMARYFXSLOTID:
            eax_get_primary_fx_slot_id();
            break;

        case EAXCONTEXT_DISTANCEFACTOR:
            eax_get_distance_factor();
            break;

        case EAXCONTEXT_AIRABSORPTIONHF:
            eax_get_air_absorption_hf();
            break;

        case EAXCONTEXT_HFREFERENCE:
            eax_get_hf_reference();
            break;
...
void ALCcontext::eax_defer_context_all()
{
    ...
    case 4:
        {
            const auto& context_all =
                eax_call_.get_value<ContextException, EAX40CONTEXTPROPERTIES>();
    ...
    case 5:
        {
            const auto& context_all =
                eax_call_.get_value<ContextException, EAX50CONTEXTPROPERTIES>();
...
void ALCcontext::eax_defer_primary_fx_slot_id()
{
    const auto& primary_fx_slot_id =
        eax_call_.get_value<ContextException, const decltype(EAX50CONTEXTPROPERTIES::guidPrimaryFXSlotID)>();
...
void ALCcontext::eax_defer_distance_factor()
{
    const auto& distance_factor =
        eax_call_.get_value<ContextException, const decltype(EAX50CONTEXTPROPERTIES::flDistanceFactor)>();
...
void ALCcontext::eax_defer_air_absorption_hf()
{
    const auto& air_absorption_hf =
        eax_call_.get_value<ContextException, const decltype(EAX50CONTEXTPROPERTIES::flAirAbsorptionHF)>();
...
void ALCcontext::eax_defer_hf_reference()
{
    const auto& hf_reference =
        eax_call_.get_value<ContextException, const decltype(EAX50CONTEXTPROPERTIES::flHFReference)>();
...
void ALCcontext::eax_set_session()
{
    const auto& eax_session =
        eax_call_.get_value<ContextException, const EAXSESSIONPROPERTIES>();
...
void ALCcontext::eax_defer_macro_fx_factor()
{
    const auto& macro_fx_factor =
        eax_call_.get_value<ContextException, const decltype(EAX50CONTEXTPROPERTIES::flMacroFXFactor)>();
...
void ALCcontext::eax_set()
{
    switch (eax_call_.get_property_id())
    {
        ...
        case EAXCONTEXT_ALLPARAMETERS:
            eax_defer_context_all();
            break;

        case EAXCONTEXT_PRIMARYFXSLOTID:
            eax_defer_primary_fx_slot_id();
            break;

        case EAXCONTEXT_DISTANCEFACTOR:
            eax_defer_distance_factor();
            break;

        case EAXCONTEXT_AIRABSORPTIONHF:
            eax_defer_air_absorption_hf();
            break;

        case EAXCONTEXT_HFREFERENCE:
            eax_defer_hf_reference();
            break;
